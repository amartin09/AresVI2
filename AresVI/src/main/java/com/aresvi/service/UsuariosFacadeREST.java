...
import com.aresvi.aresvi.Usuarios;
import com.aresvi.aresvi.UsuariosPK;
 ...
 */
@Stateless
@Path("com.aresvi.aresvi.usuarios")
public class UsuariosFacadeREST extends AbstractFacade<Usuarios> {
    ...
    private UsuariosPK getPrimaryKey(PathSegment pathSegment) {
        /*
         * pathSemgent represents a URI path segment and any associated matrix parameters.
         * URI path part is supposed to be in form of 'somePath;id=idValue;auditoriaid=auditoriaidValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        com.aresvi.aresvi.UsuariosPK key = new com.aresvi.aresvi.UsuariosPK();
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") PathSegment id, Usuarios entity) {
        super.edit(entity);
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.aresvi.aresvi.UsuariosPK key = getPrimaryKey(id);
    ...
    public Usuarios find(@PathParam("id") PathSegment id) {
        com.aresvi.aresvi.UsuariosPK key = getPrimaryKey(id);
